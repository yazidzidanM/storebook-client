        ...
        <section className="py-16 bg-linear-to-br from-indigo-600/5 via-background to-accent/30">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">
              <span className="dark:text-[#C6A96B]">About </span> BookStore
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We&lsquo;re passionate about connecting readers with their next
              great adventure through the pages of a book.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Founded in 2020, BookStore began with a simple mission: to
                    make quality books accessible to everyone in Indonesia. What
                    started as a small online shop has grown into a thriving
                    community of book lovers.
                  </p>
                  <p>
                    We believe that books have the power to transform lives,
                    spark imagination, and build bridges between people. That's
                    why we carefully curate our collection, ensuring that every
                    title we offer meets our standards of quality and value.
                  </p>
                  <p>
                    Today, we're proud to serve thousands of customers across
                    Indonesia, delivering not just books, but experiences that
                    enrich minds and souls.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="rounded-xl p-6 shadow-card text-center bg-white/60 dark:bg-white/5 dark:backdrop-blur-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Every book is handpicked to ensure it meets our quality
                  standards.
                </p>
              </div>
              <div className="rounded-xl p-6 shadow-card text-center bg-white/60 dark:bg-white/5 dark:backdrop-blur-md">
              ...
              <div className="rounded-xl p-6 shadow-card text-center bg-white/60 dark:bg-white/5 dark:backdrop-blur-md">
                ...
                <p className="text-sm text-muted-foreground">
                  We're readers too, and we understand the joy of discovering a
                  great book.
                </p>
              </div>
              <div className="rounded-xl p-6 shadow-card text-center bg-white/60 dark:bg-white/5 dark:backdrop-blur-md">
                ...
                <p className="text-sm text-muted-foreground">
                  Secure payments, fast delivery, and genuine products every
                  time.
                </p>
              </div>
            </div>
        ...
        <section className="py-16 dark:bg-linear-to-t dark:from-[#2E2E2E] dark:via-[#1A1A1A] dark:to-[#0F0F0F]">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
              <div>
                <p className="text-4xl font-serif font-bold text-indigo-600 dark:text-[#C6A96B]">
                  10K+
                </p>
